...
import com.github.claudecode.ccgui.infrastructure.eventbus.ConfigChangedEvent
...
import com.github.claudecode.ccgui.model.config.ProviderProfile
import com.github.claudecode.ccgui.model.config.SpecialProviderIds
import com.github.claudecode.ccgui.model.config.ThemeConfig
import com.github.claudecode.ccgui.util.LocalSettingsReader
...
class ConfigService(private val project: Project) : Disposable {
    ...
    private val log = logger<ConfigService>()
    ...
    private fun setupHotReload() {
        ...
        if (hotReloadManager.registerLocalSettingsFile()) {
            ...
            log.info("ConfigService: Hot reload enabled for local settings")
        }
    }
